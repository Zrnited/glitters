...
export default function Sidebar ({aside, setAside}: AsideProps) {
    return (
      <>
        ...
        <aside className={aside ? "fixed h-full bg-[#F7EBEE] shadow-lg z-30 right-0 top-0 w-2/3 transition-all ease-in-out delay-100 p-2 sm:hidden" : "-right-full fixed h-full bg-[#F7EBEE] transition-all ease-in-out delay-100 top-0 w-1/2"}>
            ...
            <div className="flex flex-col gap-y-2 grow">
              <div className="flex flex-col gap-y-3">
                <div className="flex flex-col gap-y-2">
                  <input type="text" placeholder="Enter the item name" className="pl-3 pr-10 h-[50px] border border-black focus:outline-none" />
              ...
              <div className="justify-end flex grow flex-col">
                ...
                <div className="flex flex-row gap-x-2 items-center cursor-pointer p-2">
                  ...
                  <Link href={'/signin'} className="text-lg font-semibold">Login</Link>
                </div>
              </div>
            </div>
          </div>
